...
<html>
    <head>
        ...
        <link href="site/admin/css/bootstrap.css" rel="stylesheet" type="text/css" />
        <link href="site/new/css/map.css" rel="stylesheet" type="text/css" />
        <link href="site/admin/css/dt.css" rel="stylesheet" type="text/css" />
        <link href="site/admin/css/main.css" rel="stylesheet" type="text/css" />


        <!-- jQuery Javascript -->
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/jquery-ui.min.js"></script>
        <script type="text/javascript" language="javascript" src="site/admin/js/jquery.dataTables.js"></script>
        <script src="../plugins/ckeditor/ckeditor.js"></script>
        <script src="../plugins/ckfinder/ckfinder.js"></script>

        <!-- Bootstrap Javascript -->

        <script src="site/admin/js/bootstrap.js"></script>

        <!-- Nemean Javascript -->
        <script src="site/admin/js/jquery.confirm.js"></script>
        <script src="site/admin/js/Nemean.js"></script>
        <script src="site/admin/js/main.js"></script>
        <script src="site/admin/js/user.js"></script>
