...
<table width="100%" id="table_'.$row['id'].'">\
  <tr>\
    ...
    <td width="10%">'.$row['price'].' Kr</td>\
    <td width="15%"><select name="'.$row['id'].'_cnt" id="'.$row['id'].'_cnt" onchange="change('.$row['id'].');" style="visibility: hidden;">\
	<option value="1">1</option>\
	<option value="2">2</option>\
	<option value="3">3</option></select>\
	\
	</td>\
	<td width="15%"><a href="#" onclick="remove('.$row['id'].');return false;" class="remove">Fjern</a></td>\
  </tr>\
</table>\'}';
?>
