...
$(document).ready(function(){
	...
	$('.product').simpletip({
        ...
        offset: [-650, -620],
		content:'<img src="resources/img/kiosk/img/ajax_load.gif" alt="loading" style="margin:10px;" />',
		onShow: function(){
			...
			this.load('?m=kiosk&aAct=JSONgetProduct',{img:param});
		}
...
function addlist(param)
{
	$.ajax({
	type: "POST",
	url: "?m=kiosk&aAct=JSONaddToCart",
...
function update_total()
{
	if(totalprice)
	{
		$('#total').html('Totalt: '+parseInt(totalprice)+' Kr');
